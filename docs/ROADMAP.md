...
| [WI-039](work_items/WI-039-python-project-structure.md) | Declared Python project config; no `sys.path` repair | `[NEEDS DESIGN]` | None | Settle how the compiled binding is resolved |
